...
resultado = {"seed": options.seed, "size": options.heapSize, "baseAddr": options.baseAddr,
            "headerSize":options.headerSize, "alignment":options.alignment,"alignment":options.alignment,
